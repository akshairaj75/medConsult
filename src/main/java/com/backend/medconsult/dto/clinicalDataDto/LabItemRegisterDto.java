...
public class LabItemRegisterDto {
    private UUID itemId;
    ...
    public static LabItemRegisterDto fromEntity(LabItem labItem) {
        LabItemRegisterDto dto = new LabItemRegisterDto();
        dto.setItemId(labItem.getItemId());
        dto.setLabResultId(labItem.getLabResult().getLabResultId());
